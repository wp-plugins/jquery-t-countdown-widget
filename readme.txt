...
== Screenshots ==
w
1. Screen shot screenshot-1.png shows the available options of the `jQuery T(-) CountDown Widget`.
1. Screen shot screenshot-2.png shows the `jQuery T(-) CountDown Widget` in hot on-page action.
